...
import { barHeaderTypography, eachSkillBox, eachSkillEndBox, flexWraperBox, linksTypography, mainHeaderTypography, pageRenderingBox } from "../Assets/data/styling";
        ...
        <Box>
            ...
            <Box id='page5' style={pageRenderingBox} >
                ...
                <Box style={eachSkillBox} >
                    ...
                    <PersonalityProgress messageData={setAnalyticalMessageValue} messagesArray={skillAchived} scoreData={skillData[0].persentageScore} />
                ...
                <Box style={eachSkillEndBox} >
                    ...
                    <PersonalityProgress messageData={setCodingMessageValue} messagesArray={skillAchived} scoreData={skillData[5].persentageScore} />
            ...
            <Box id='page6' style={pageRenderingBox} >
                ...
                <Box style={eachSkillBox} >
                    ...
                    <PersonalityProgress messageData={setComputerFundamentalsMessageValue} messagesArray={skillAchived} scoreData={skillData[4].persentageScore} />
                ...
                <Box style={eachSkillEndBox} >
                    ...
                    <PersonalityProgress messageData={setEnglishMessageValue} messagesArray={skillAchived} scoreData={skillData[2].persentageScore} />
            ...
            <Box id='page7' style={pageRenderingBox} >
                ...
                <Box style={eachSkillBox} >
                    ...
                    <PersonalityProgress messageData={setQuantitativeMessageValue} messagesArray={skillAchived} scoreData={skillData[1].persentageScore} />
                ...
                <Box style={eachSkillEndBox} >
                    ...
                    <PersonalityProgress messageData={setDomainMessageValue} messagesArray={skillAchived} scoreData={skillData[3].persentageScore} />
            ...
            <Box id='page8' style={pageRenderingBox} >
                ...
                <Box style={eachSkillEndBox} >
                    ...
                    <PersonalityProgress messageData={setWETMessageValue} messagesArray={skillAchived} scoreData={skillData[6].persentageScore} />
